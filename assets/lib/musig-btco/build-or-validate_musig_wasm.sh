#!/bin/bash
# https://github.com/PlasmaPower/musig-btco
...
source ~/.cargo/env
cd /root
git clone https://github.com/PlasmaPower/musig-btco.git
cd musig-btco
...
BUILD
cat /root/musig-btco/target/wasm32-wasi/release/musig_nano.wasm | base64
EOF
