...
import { createIcon } from '../../../../assets/lib/btcoidenticons.min.js';

@Component({
  selector: 'app-btco-identicon',
  templateUrl: './btco-identicon.component.html',
  styleUrls: ['./btco-identicon.component.css'],
})
