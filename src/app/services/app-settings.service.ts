...
export class AppSettingsService {
  ...
  serverOptions = [
    ...
    {
      name: 'Bitcoin Nano Temp',
      value: 'btco',
      api: 'http://peering.bitcoinnano.org:7076',
      ws: 'ws://peering.bitcoinnano.org:7078',
      auth: null,
      shouldRandom: true,
    },
    {
      name: 'Bitcoin Nano Nault',
      value: 'btconault',
      api: 'https://btconault-api.bitcoinnano.org',
      ws: 'wss://btconault-ws.bitcoinnano.org',
      auth: null,
      shouldRandom: true,
    },
    {
      name: 'btco node',
      value: 'btconode',
      api: 'https://api.bitcoinnano.org',
      ws: 'wss://ws.bitcoinnano.org',
      auth: null,
      shouldRandom: true,
    },
    {
