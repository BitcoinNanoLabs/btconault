...
export class PriceService {
  storeKey = `btcovault-price`;
  apiUrl = `https://api.coingecko.com/api/v3/coins/btco?localization=false&tickers=false&market_data=true&community_data=false&developer_data=false&sparkline=false`;
