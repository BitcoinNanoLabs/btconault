...
export class AppComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    try {
      ...
      this.notifications.sendWarning(`There was an issue retrieving latest Bitcoin Nano price.  Ensure your AdBlocker is disabled on this page then reload to see accurate FIAT values.`, { length: 0, identifier: `price-adblock` });
    }
  }
